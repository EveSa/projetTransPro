...
for file in directory :
    ...
    boundingbox_test = getBoundingBox('./corpus_final_jpg'+nomfile+'/page3.jpg') #On obtient une liste de tuples contenant les bordures des boîtes qui ont été marquée en vert dans le fichier jpg
